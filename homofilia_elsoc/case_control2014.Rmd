...
ego_network_enacoes_2014<-ego_network_enacoes_2014%>%
  dplyr::select(idencuesta, ego_sexo, alter_sexo1, alter_sexo2, alter_sexo3, alter_sexo4, 
                ...
                ego_ideol, alter_ideol1,alter_ideol2,alter_ideol3,
                alter_ideol4,alter_ideol5,
...
names(ego_network_enacoes_2014)<- c('idencuesta','sexo','sexo1','sexo2','sexo3','sexo4','sexo5', 
...
```{r}
ego_network_enacoes_2014[] <- lapply(ego_network_enacoes_2014, as.character)
...
ego_network_enacoes_2014_ego<-ego_network_enacoes_2014%>%
  dplyr::select(idencuesta,sexo,edad,educ,relig,barrio,ideol,tamred,POND_MUESTRAL)

ego_network_enacoes_2014alter<-ego_network_enacoes_2014%>%
...
# reshape
ego_network_enacoes_2014_long<-long_panel(ego_network_enacoes_2014alter, prefix="", begin=1, end=5, label_location="end")

# filter
ego_network_enacoes_2014_long_nofam<-ego_network_enacoes_2014_long%>%
  dplyr::filter(relacion =="nofam")

# to wide
ego_network_enacoes_2014_nofam<-widen_panel(ego_network_enacoes_2014_long_nofam, separator = "")
ego_network_enacoes_2014_nofam<-as.matrix(ego_network_enacoes_2014_nofam)
ego_network_enacoes_2014_nofam<-as.data.frame(ego_network_enacoes_2014_nofam)
ego_network_enacoes_2014_nofam$id<-NULL

# join
ego_network_enacoes_2014_nofam<-dplyr::left_join(ego_network_enacoes_2014_nofam, 
                                                 ego_network_enacoes_2014_ego, 
                                                 by="idencuesta")%>%
  dplyr::select(idencuesta,tamred,sexo,sexo1,sexo2,sexo3,sexo4,sexo5,
                ...
                relacion3,relacion4,relacion5,POND_MUESTRAL)
# to numeric
