...
## Cargamos data 
```{r}
load("/home/rober/Documents/ELSOC/ELSOC_W02_v3.00_R.RData")
load("/home/rober/Documents/ELSOC/ELSOC_W04_v2.01_R.RData")
load("/home/rober/Documents/ELSOC/ELSOC_W01_v4.01_R.RData")
```
...
elsoc_ego <- egor(alters = alteris, 
                  ...
                  ego_design = list(strata = stype, weights = pw,
                           nest = TRUE),
                  ID.vars = list(
                    ego = ".egoID",
...
## Modelo 6
```{r, message=FALSE}
modelo6<-ergm.ego(elsoc_ego~ edges + 
